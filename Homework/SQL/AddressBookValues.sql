...
INSERT INTO User (id, name, surname, dateBirth, placeBirth, nCell, nPhone, email, personalSmartphone) VALUES
				(1,'Simona', 'Palumbo', '1992-02-21', 'Napoli', 3318096926, 0815867586, 'simona.palumbo@hotmail.it', 1),
                (2,'Francesco', 'Randillo', '1994-10-19', 'Ariano Irpino', 3468315563, 0821117586, 'francescorandillo@live.it', 18),
                (3,'Antonia', 'Coviello', '1991-05-12', 'Napoli', 3333478590, 0838977996, 'antoniacoviello@gmail.com', 13),
                (4,'Francesca', 'Di Mare', '1981-09-30', 'Pozzuoli', 331987626, 0813589436, 'francesca.dimare@hotmail.it', 7),
                (5,'Francesco', 'Vietri', '1988-10-09', 'Salerno', 3467895647, 0345674897, 'francesco.vietri@hotmail.it', 2),
				(6,'Silverio', 'Vaira', '1988-10-28', 'Castel Nuovo', 3334563298, 0234565789, 'silverio.vaira@hotmail.it', 1),
                (7,'Francesco', 'Riccardo', '1988-07-05', 'Fisciano', 3938769587, 0898757647, 'francesco.riccardo@live.it', 8),
                (8,'Angelo', 'Giordano', '1987-09-04', 'Battipaglia', 3348796059, 0387689587, 'angelo.giordano@hotmail.it', 12),
                (9,'Mario', 'Saponara', '1985-08-05', 'Agropoli', 3337658990, 0578698768, 'mario.saponara@live.it', 1),
                (10,'Francesco', 'Canaglia', '1991-05-14', 'Brindisi', 3332454678, 0897865746, 'francesco.canaglia@hotmail.it', 15);
